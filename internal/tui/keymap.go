...
var tuiKeys = tuiKeyMap{
	...
	Models:         key.NewBinding(key.WithKeys("alt+m"), key.WithHelp("alt+m", "models")),
...
func (k tuiKeyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.Submit, k.Newline, k.Paste, k.Mode, k.Thinking, k.PageUp, k.PageDown}
}

// FullHelp implements bubbles/help.KeyMap for the detailed /help output.
func (k tuiKeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		{k.Submit, k.FollowUp, k.Newline, k.Paste, k.Abort, k.Quit, k.Mode, k.Thinking, k.Models, k.Agents, k.Processes},
...
func applyKeybindingOverrides(base tuiKeyMap, overrides map[string][]string) (tuiKeyMap, error) {
	...
	if err := validateBindingCollisions(map[string]key.Binding{"submit": base.Submit, "newline": base.Newline, "paste": base.Paste, "toggle_mode": base.Mode, "thinking": base.Thinking, "models": base.Models, "agents": base.Agents, "processes": base.Processes, "abort": base.Abort}); err != nil {
		return base, err
	}
	...
	if err := validateBindingCollisions(map[string]key.Binding{"submit": base.Submit, "follow_up": base.FollowUp, "thinking": base.Thinking, "models": base.Models, "agents": base.Agents, "processes": base.Processes, "abort": base.Abort}); err != nil {
		return base, err
	}
	if err := validateBindingCollisions(map[string]key.Binding{"models": base.Models, "agents": base.Agents, "processes": base.Processes, "quit": base.Quit}); err != nil {
		return base, err
	}
	if err := validateBindingCollisions(map[string]key.Binding{"picker_up": base.PickerUp, "picker_down": base.PickerDown, "picker_previous": base.PickerPrev, "picker_next": base.PickerNext, "picker_page_up": base.PickerPageUp, "picker_page_down": base.PickerPageDown, "picker_top": base.PickerTop, "picker_bottom": base.PickerBottom, "accept": base.Accept, "close": base.Close, "branch_fork": base.BranchFork, "branch_rename": base.BranchRename, "branch_delete": base.BranchDelete, "confirm": base.Confirm, "models": base.Models, "agents": base.Agents, "processes": base.Processes}); err != nil {
		return base, err
	}
