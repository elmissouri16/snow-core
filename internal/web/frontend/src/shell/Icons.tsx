export type Glyph = 'panel' | 'close' | 'chat' | 'new' | 'folder' | 'search' | 'list' | 'plus' | 'chevron' | 'settings' | 'activity' | 'snow' | 'light' | 'dark';
export function Icon({name, className = 'icon'}: {name: Glyph; className?: string}) {
  const paths: Record<Exclude<Glyph, 'snow'>, string> = {
    ...
    plus: 'M12 5v14M5 12h14', chevron: 'm9 5 7 7-7 7', settings: 'm9 3-1 3-3 1-2 5 2 5 3 1 1 3h6l1-3 3-1 2-5-2-5-3-1-1-3ZM16 12a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z',
