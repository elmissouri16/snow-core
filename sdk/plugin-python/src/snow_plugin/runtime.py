...
_KNOWN_EVENT_TYPES = frozenset(
    {
        ...
        "aborted", "model_changed", "mode_changed", "plan_started",
        "plan_delta", "plan_completed", "plan_update", "compaction_started",
        "compaction_done", "thread_goal_updated", "subagent_started",
        "subagent_status", "subagent_message", "subagent_activity",
    }
)
MAX_ACTIVE_CALLS = 8
MAX_EVENT_QUEUE = 64
            ...
            if method == "notifications/cancelled":
                ...
                if isinstance(event_type, str) and event_type in _KNOWN_EVENT_TYPES:
                    try:
                        ...
                        # Events are observation-only, bounded, and best effort.
                        pass
            return
