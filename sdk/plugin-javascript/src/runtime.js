...
export async function serve(plugin, { maxConcurrency = DEFAULT_MAX_CONCURRENCY, maxEventQueue = DEFAULT_MAX_EVENT_QUEUE } = {}) {
  ...
  const dispatcher = new EventDispatcher(plugin, { maxQueue: maxEventQueue });
  ...
  async function handleToolsCall(id, params = {}) {
    ...
    const entry = { controller, requestId: String(id), callId, done };
    activeRequests.set(String(id), entry);
